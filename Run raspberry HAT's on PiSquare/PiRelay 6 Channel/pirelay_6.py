...
relay5.value(0)#initally relay5 at LOW
relay6.value(0)#initally relay6 at LOW

time.sleep(1)

while 1:
    relay1.value(1)#initally relay1 at HIGH
    relay2.value(1)#initally relay2 at HIGH
    relay3.value(1)#initally relay3 at HIGH
    relay4.value(1)#initally relay4 at HIGH
    relay5.value(1)#initally relay5 at HIGH
    relay6.value(1)#initally relay6 at HIGH
